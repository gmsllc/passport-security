...
// kvs = require('kvs'),
    ...
    PassportSecurity = function (config) {
        ...
        var _self = this || {},
            testBucketTTL = config.testBucketTTL || 2;
        ...
        var startupTimer = setTimeout(function () {
            throw new Error('PASSPORT-SECURITY did not startup properly');
        }, 30000);
        ...
        _self.removeFromIDBlacklist = function (id, cb) {
            ...
            _self.config.idBlacklistBucket.del(id, function (err, data) {
                ...
                _self.config.accountBucket.set(id, [], cb || function(err, data){
