...
module.exports = function (config) {
    ...
    _self.addToIPBlacklist = function(ip, cb){
        ...
        _self.config.ipBlacklistBucket.set(ip, true, cb || function(err, data){
    ...
    _self.addToIDBlacklist = function(id, cb){
        ...
        _self.config.idBlacklistBucket.set(id, true, cb || function(err, data){
    ...
    _self.addToCLUUIDBlacklist = function(id, cb){
        ...
        _self.config.cluuidBlacklistBucket.set(id, true, cb || function(err, data){
            if(_self.config.debug) console.log("Result of adding ID to Blacklist:"+id+' : '+util.inspect({
                err: err,
                data:data
            }));
