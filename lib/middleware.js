                                    ...
                                    async.parallel({
                                        ...
                                        if (!err && filteredData.records) {
                                            ...
                                            for (var rec in _this.records) {
                                                ...
                                                if(_this.records && _this.records[rec] && typeof _this.records[rec] === 'object'){
                                                    thisRec = _this.records[rec];
                                                }
                                                ...
                                                if(thisRec) {
                                                    ...
                                                    _this.ids.push(thisRec.id);
                                                    _this.ips.push(thisRec.ip);
                                                    _this.cluuids.push(thisRec.cluuid);
                                                    _this.geos.push(thisRec.geo);

                                                    _this[result].ids.push(thisRec.id);
                                                    _this[result].ips.push(thisRec.ip);
                                                    _this[result].cluuids.push(thisRec.cluuid);
                                                    _this[result].geos.push(thisRec.geo);
                                                }
                                            }
